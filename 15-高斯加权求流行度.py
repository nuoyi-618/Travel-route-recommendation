# -*- coding: utf-8 -*-
"""
Created on Sun Aug  5 10:29:27 2018
...
import math
import numpy as np
df = pd.read_csv('../data/2/user-poi.csv') 
...
for key in pieces:
    ...
    poildx.append(LXD)
df2 = pd.read_csv('../data/2/poi-TZ-161w(6-100).csv') 
#标准化
...
df2 = pd.concat([df2,b])
df2.to_csv('../data/2/new-poi-TZ2-161w(6-100).csv',index=False)